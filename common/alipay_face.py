...
# api文档 https://opendocs.alipay.com/open/194/105072?pathHash=45357796
...
class AliPayFace:
    ...
    def __init__(self, app_id, app_private_key, alipay_public_key, notify_url=None, sandbox_debug=False):
        ...
        '''
        self.client = DefaultAlipayClient(alipay_client_config=alipay_client_config, logger=AliPayFace.logger)
    ...
    def query(self, out_trade_no):
        ...
        if not query_response_content:
            ...
            if query_response.is_success():
                ...
                ret_dict['code'] = query_response.code
                ret_dict['msg'] = query_response.msg
                ret_dict['sub_code'] = query_response.sub_code
                ret_dict['sub_msg'] = query_response.sub_msg
